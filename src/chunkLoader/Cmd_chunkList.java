...
public class Cmd_chunkList implements CommandExecutor{

	@Override
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {	
		//Comando eseguibile da tutti i sender type
		if(cmd.getName().equalsIgnoreCase("chunklist")) {
			//Controllo permesso
			if(sender.hasPermission("chunkloader.use")) {				
				List<String> l = ChunkLoader.getChunkList();
				sender.sendMessage(Main.getInstance().getConfig().getString("ChunkLoader.messages.chunklist-msg"));
